...
\[
-\frac{\hbar^2}{2m} \frac{d^2\psi}{dx^2} + V(x)\psi = E\psi \tag{2.2}
\]
...
\[
T_{\text{WKB}} = \exp\left(-2\int_{x_1}^{x_2} \kappa(x) dx\right), \quad \kappa(x) = \sqrt{\frac{2m[V(x)-E]}{\hbar^2}} \tag{2.3}
\]
...
\[
T = \frac{1}{1 + \frac{V_0^2 \sinh^2(\kappa d)}{4E(V_0-E)}}, \quad \kappa = \sqrt{\frac{2m(V_0-E)}{\hbar^2}} \quad (E < V_0) \tag{2.4}
\]
...
\end{pmatrix}, \quad \Delta(t) = \alpha t \tag{2.6}
\]
...
\[
T = \left[ 1 + \frac{V_0^2 \sinh^2(\kappa d \eta)}{4E(V_0-E)} \right]^{-1} \tag{2.8}
\]
...
\[
E_n = V_0 - \frac{n^2\pi^2\hbar^2}{2m_{\text{eff}} d^2}, \quad n=1,2,3,\dots \tag{2.9}
\]
...
\[
T = \frac{1}{1 + \sinh^2(\delta/\xi) \cos^2\theta} \tag{2.10}
\]
